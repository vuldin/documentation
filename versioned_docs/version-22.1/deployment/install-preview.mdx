...
If you face any errors during your installation or upgrading process, feel free to reach us in our [Slack Community](https://redpanda.com/slack) or on [GitHub Discussions](https://github.com/redpanda-data/redpanda/discussions). 
