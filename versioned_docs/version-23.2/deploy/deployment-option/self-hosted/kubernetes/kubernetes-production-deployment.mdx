...
:::tip
If you are using the Redpanda Helm chart and want to migrate to the latest Redpanda Operator to manage your deployment, see [Migrate from the Redpanda Helm chart](../../../../../upgrade/migrate/kubernetes/helm-to-operator).
:::
