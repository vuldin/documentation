...
The Redpanda image contains the `rpk` and `redpanda` binaries. Use the `rpk` CLI utility to work with your Redpanda nodes. See the [rpk commands](/docs/21.11/reference/rpk-commands) documentation for a full list of commands. 
