...
6. (Optional) Under **Additional Configuration**, add more topic properties.
    ...
    Redpanda supports all Apache Kafka topic configuration properties and all Redpanda-specific [topic configuration properties](../../../../reference/cluster-properties/#topic-and-partition-properties).
7. Click **Create**.
